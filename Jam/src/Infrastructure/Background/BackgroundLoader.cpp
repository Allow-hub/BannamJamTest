...
namespace Jam::Infrastructure::Background {
    ...
    bool BackgroundLoader::loadBackgroundFromFile(const String& fileName, Jam::Foundation::StageName stageName, Array<Jam::Domain::Background::BackgroundObject>& outObjects) {
    ...
    bool BackgroundLoader::loadBackgroundFromFile(const String& fileName, const String& stageName, Array<Jam::Domain::Background::BackgroundObject>& outObjects) {
    ...
    bool BackgroundLoader::parseBackgroundObject(const JSON& json, Jam::Domain::Background::BackgroundObject& outObj) {
        // 必須フィールドのチェック
